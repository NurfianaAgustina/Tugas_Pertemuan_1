>> % LATIHAN HALAMAN 47
>> % 1. Mengoperasikan matriks M dan N:
>> M = [10 20; 5 8];
>> N = [-1 1; 1 -1];
>> M + N, M + N, N + 9
ans =
...
>>
>> % 2. Menghitung dot-product dan cross-product dari dua vektor:
>> a = [0 5 5]; b = [1 1 1];
>> dot (a,b)
ans = 10
>> cross(a,b), cross(b,a)
...
>>
>> % 3. Pecahkanlah persamaan linear tiga variabel berikut:
...
>>
>> % 5. Buatlah tabel hiperbolik-trigonometri: sinh, cosh, dan tanh untuk rentang -5 <= x <= 5, dengan
inkremen x sebesar 0,1.
